...
public class AddDocCommandParser implements Parser<AddDocCommand> {
    ...
    public AddDocCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ADDRESS, PREFIX_PHONE, PREFIX_EMAIL)
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddDocCommand.MESSAGE_USAGE));
        }
        ...
        Doctor doctor = new Doctor(name, phone, email, address, tagList);

        return new AddDocCommand(doctor);
    }
